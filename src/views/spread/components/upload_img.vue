    ...
    <div class="upload_image_box" v-show="show1">
      <div class="upload_image">
        <div class="photo_box" @click="actionSheet()">
          <img class="icon_photo" src="../../../assets/images/icon_banji_x.png" />
          <p><span>shangchuan</span></p>
        </div>
      </div>
    </div>
    <div class="uploaded" v-show="show2">
      <div v-for="(item,index) in imgLists" class="imgItem">
        <img @click="deleteImg(index)" class="delete" src="../../../assets/images/icon_jiaoshi_x@3x.png">
        <img :src="item" class="img" @click="previewPicture(index)">
      </div>
      <div class="imgUpload" @click="actionSheet()">
        <img class="icon_photo" src="../../../assets/images/icon_kecheng_x.png" />
        <p><span>xiazai</span></p>
      </div>
    </div>
  </div>
</template>
